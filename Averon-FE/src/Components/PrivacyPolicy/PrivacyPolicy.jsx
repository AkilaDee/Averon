...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-page" style={{ maxWidth: 820, margin: '0 auto', padding: '48px 24px', lineHeight: 1.7 }}>
      ...
      <p><em>Last updated: 03/08/2026</em></p>
      ...
      <p>
        ...
        receives your message and forwards it to us by email. Web3Forms stores
        submissions on servers in the United States, encrypted at rest, and deletes
        them automatically after 30 days. To prevent spam, they may pass the IP
        address and email address of form submitters to the filtering services
        CleanTalk and Akismet. This involves a transfer of personal data outside the
        UK.
      </p>
      <p>We keep enquiry correspondence for 12 months and then delete it.</p>

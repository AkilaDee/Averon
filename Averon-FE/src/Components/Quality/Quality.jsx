...
const quality = () => {
  return (
    ...
    <div className="premium-pillars">
        ...
        <div className="pillar">
            {/* <span className="pillar-icon">🧪</span> */}
            <h3>Ultra-High Essential Oil Content</h3>
            <p>Maximum potency, aroma, and therapeutic benefit.</p>
        </div>
    </div>
    ...
    {/* The Final Summary */}
    {/* <p className="sub-text">Our Cinnamon is tested to meet the highest standards in the industry.</p> */}
    {/* <div className="divider-gold"></div> */}

      ...
      <div className="quality-split-row">
        <div className="quality-text-block">
          <p className="highlight-lead-text">
            <strong>Do you have any questions for our category experts regarding a certain product? Talk to the team today on <span className="text-link">info@averonsupplies.co.uk</span> or +447344469729.</strong>
          </p>

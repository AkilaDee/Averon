    ...
    <div className='about'>
        ...
        <div className='about-right'>
            ...
            <p>Averon Supplies Ltd operates as a strategic bridge between the specialized spice gardens of Sri Lanka and the exacting requirements of the British food industry. 
              ...
              The company provides a comprehensive sense of security through operations anchored by a robust HACCP food safety system. 
      ...
      <div className='about-bottom'>
          <p>As a vertically integrated entity, Averon Supplies Ltd is structured to redefine the spice supply chain by providing direct estate-to-enterprise access. 
            ...
            every consignment is verified against rigorous standards before leaving the origin. <br /><br />

            As a primary distributor, the company provides the food industry with the logistical reliability and technical documentation necessary for modern supply chain management. 
            ...
            and batch-coded traceability. Through reliable distribution and ambient-stable bulk supplies tailored to specific inventory needs, 
